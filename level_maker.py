...
for i in range(16, 76):
    obstacle_rects = []
    obstacle_type = random.choice(["ghost", "moving", "switch"])
    ...
    if i > 50:
        levels[str(i)] = {"obstacle_rect": [obstacle_1, reset_obstacle(random.choice(["moving", "bouncy", "switch"])), reset_obstacle(random.choice(["moving", "bouncy", "switch"]))], "target_rect": reset_target(max_height)}
    elif i > 28:
        levels[str(i)] = {"obstacle_rect": [obstacle_1, reset_obstacle(random.choice(["moving", "bouncy", "switch"]))], "target_rect": reset_target(max_height)}
    else:
